...
import { CrestHomeInterface } from './crest-home.interface';
...
@Component({
  selector: 'app-crest-home',
  templateUrl: './crest-home.component.html',
  styleUrls: ['./crest-home.component.scss'],
  animations: [
    trigger('bounce', [
      state('move', style({
...
export class CrestHomeComponent extends PosScreenDirective<CrestHomeInterface> {
