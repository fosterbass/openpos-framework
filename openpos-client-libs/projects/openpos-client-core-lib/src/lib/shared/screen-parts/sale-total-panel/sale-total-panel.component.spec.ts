        ...
        describe('template', () => {
            describe('sale-total-header', () => {
                const configureComponent =
                    (readOnly: boolean, linkedCustomerButton: IActionItem, loyaltyButton: IActionItem, customer = undefined) => {
                    ...
                    describe('linked customer button', () => {
                        ...
                        it('shows the keybinding when keybinds are enabled', () => {
                            ...
                            button = fixture.debugElement.query(
                                By.css('.sale-total-header .linked-customer-summary .loyalty-keybind'));
