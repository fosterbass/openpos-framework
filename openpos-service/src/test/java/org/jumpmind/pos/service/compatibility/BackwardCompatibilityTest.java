...
public class BackwardCompatibilityTest {
    ...
    public void testNoVersionGet() {
        ...
        Assert.assertEquals(response.getCustomerModel().getCustomerId(), "1234");
    ...
    public void testResponseChildObjectReplace() throws Exception {
        ...
        Assert.assertEquals(response.getCustomerModel().getCustomerV09Field(), "V09 field set");
    }
    ...
    public void testPathSpecificResponse() throws Throwable {
        ...
        Assert.assertEquals(response.getCustomerModel().getCustomerId(), "visited unlinkCustomer response filter");
    }
