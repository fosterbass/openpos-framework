...
import { SaleLoyaltyPartComponent } from './sale-loyalty-part.component';
...
describe('SaleLoyaltyPartComponent', () => {
    ...
    let fixture: ComponentFixture<SaleLoyaltyPartComponent>;
    ...
    describe('non mobile', () => {
        ...
        beforeEach(async () => {
            ...
            fixture = TestBed.createComponent(SaleLoyaltyPartComponent);
            component = fixture.componentInstance;
            component.screenData = {
                profileIcon: 'account_circle'
            } as SaleLoyaltyPartInterface;
            ...
            describe('sale-loyalty', () => {
                ...
                describe('when no customer is linked', () => {
                    ...
                    it('does not show the linked customer button', () => {
                        validateDoesNotExist(fixture, '.sale-loyalty .linked-customer-summary');
                    });

                    it('calls doAction with the loyaltyButton when an actionClick event is triggered', () => {
                        spyOn(component, 'doAction');
                        const button = fixture.debugElement.query(By.css('.sale-loyalty .link-customer'));
                    ...
                    it('shows the keybinding when keybinds are enabled', () => {
                        ...
                        fixture.detectChanges();
                        const button = fixture.debugElement.query(By.css('.sale-loyalty .link-customer .loyalty-keybind'));
                    ...
                    it('hides the keybinding when keybinds are disabled', () => {
                        ...
                        fixture.detectChanges();
                        validateDoesNotExist(fixture, '.sale-loyalty .link-customer .loyalty-keybind');
                    });
                });
                describe('when a customer is linked', () => {
                    beforeEach(() => {
                        configureComponent(false, { keybindDisplayName: 'F7' } as IActionItem, {
                            name: 'bob',
                            label: 'manager',
                            icon: undefined,
                            id: '123'
                    ...
                    it('does not show the link customer button', () => {
                        validateDoesNotExist(fixture, '.sale-loyalty .link-customer');
                    });

                    it('shows the linked customer button', () => {
                        const button = fixture.debugElement.query(By.css('.sale-loyalty button.linked-customer-summary'));
                        expect(button.nativeElement).toBeDefined();
                    });

                    describe('loyalty button with linked customer', () => {
                        let button;
                        beforeEach(() => {
                            button = fixture.debugElement.query(By.css('.sale-loyalty button.linked-customer-summary'));
                        });

                        it('displays a account_circle icon', () => {
                            const icon = fixture.debugElement.query(By.css('.sale-loyalty .icon'));
                        ...
                        it('calls doAction with the loyaltyButton when an clickEvent event is triggered on the app-membership-display component', () => {
                            spyOn(component, 'doAction');
                        ...
                        it('shows the keybinding when keybinds are enabled', () => {
                            ...
                            button = fixture.debugElement.query(
                                By.css('.sale-loyalty .linked-customer-summary .loyalty-keybind'));
                        ...
                        it('hides the keybinding when keybinds are disabled', () => {
                            spyOn(component, 'keybindsEnabled').and.returnValue(false);
                            fixture.detectChanges();
                            validateDoesNotExist(fixture, '.sale-loyalty .linked-customer-summary .loyalty-keybind');
                        });
                        ...
                        describe('when customerMissingInfoEnabled is true', () => {
                            ...
                            describe('when customerMissingInfo is true', () => {
                                ...
                                it('dose not show the customer memberships', () => {
                                    component.screenData.membershipEnabled = true;
                                ...
                                it('dose not show the no memberships label', () => {
                        ...
                        describe('when membershipEnabled is false', () => {
                            beforeEach(() => {
                                component.screenData.membershipEnabled = false;
                                fixture.detectChanges();
                                button = fixture.debugElement.query(By.css('.sale-loyalty button.linked-customer-summary .loyaltyId'));
                            });
