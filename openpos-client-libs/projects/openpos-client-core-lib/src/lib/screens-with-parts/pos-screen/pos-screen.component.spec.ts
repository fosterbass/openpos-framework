...
import { PosScreenDirective } from './pos-screen.component';
...
class TestComponent extends PosScreenDirective<ITestScreen>{
...
describe('pos-screen', () => {
    ...
    it('should copy over all the props to the existing screen obj when show is called', () => {
        ...
        const testScreen = { testProp: 'test' } as ITestScreen;
    ...
    it('should call the action service when do action is called with and IActionItem', () => {
        const testAction = { action: 'testAction' } as IActionItem;
