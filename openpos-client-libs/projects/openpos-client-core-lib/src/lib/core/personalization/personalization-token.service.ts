...
export class PersonalizationTokenService {
    ...
    static readonly BASE_SERVER_URL_TOKEN = '${serverBaseUrl}';
    ...
    public replaceTokens(value: string): string {
        ...
        const serverBaseUrl = this.discoveryService.getServerBaseURL();
        ...
        url = url.replace(PersonalizationTokenService.BASE_SERVER_URL_TOKEN, serverBaseUrl);
